    ...
    <div className="min-h-screen bg-gradient-to-br from-[#042F6A] to-[#4EB2F1] p-8 lg:p-12 flex flex-col">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link 
          ...
          className="flex items-center gap-2 bg-white/95 hover:bg-white text-[#042F6A] font-semibold px-2 py-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-200"
        >
      ...
      {products.length > 0 ? (
        <div className="flex-1 flex items-center justify-center">
          <ProductCarousel products={products} intervalMs={5000} orientation={settings?.layout.config.imageOrientation || ImageOrientation.Landscape} />
        </div>
      ) : (
        <div className="flex-1 flex items-center justify-center">
